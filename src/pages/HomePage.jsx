...
function HomePage() {
 ...
 "https://images.unsplash.com/photo-1558981806-ec527fa84c39?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
  ...
  return (
    <>
      <Helmet>
        <title>Home Movers Nairobi - Your Trusted Moving Partner</title>
        <meta
          name="description"
          content="Home Movers Nairobi offers fast, reliable, and affordable moving services for homes and businesses in Nairobi and surrounding areas."
        />
        <meta
          name="keywords"
          content="home movers, Nairobi, moving services, relocation, office moving, vehicle options"
        />
        <meta property="og:title" content="Home Movers Nairobi - Your Trusted Moving Partner" />
        <meta
          property="og:description"
          content="Fast, reliable, and affordable moving services for homes and businesses in Nairobi and surrounding areas."
        />
        <meta property="og:image" content="https://homemoversnairobi.com/og-image.jpg" />
        <meta property="og:url" content="https://homemoversnairobi.com" />
        <meta name="twitter:card" content="summary_large_image" />
      </Helmet>
      <div className="bg-[#546581] text-white">
        {/* Hero Section */}
        <section className="relative h-screen flex items-center justify-center">
          <div className="absolute inset-0 z-0">
            ...
            />
            <div className="absolute inset-0 bg-#546581 bg-opacity-50"></div>
          </div>
          <div className="relative z-10 text-center text-white animate-fadeIn">
            <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight">
              Your Trusted Moving Partner in Nairobi
            </h1>
            ...
            <Link
              to="/booking"
              className="bg-[#8B6465] text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-opacity-90 transition duration-300 animate-slideIn"
            >
              Book Now
            </Link>
          </div>
        ...
        {/* Features Section */}
        <section className="py-16 bg-[#546581]">
        ...
        <section className="py-16 bg-[#546581]">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">Our Vehicle Options</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {vehicles.map((vehicle) => (
                <div
                  key={vehicle.name}
                  className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:scale-105 animate-fadeIn"
                >
                  <img
        ...
        <section className="py-16 bg-[#546581]">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">What Our Customers Say</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial) => (
                <div key={testimonial.name} className="bg-white rounded-lg shadow-md p-6 animate-slideIn">
                  <div className="flex items-center mb-4">
                    ...
                    />
                    <div>
                      <h4 className="font-semibold text-[#546581]">{testimonial.name}</h4>
        ...
        <section className="py-16 bg-[#546581]">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">Our Service Area</h2>
            ...
            <p className="text-center mt-4 text-white opacity-80">
...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-md animate-fadeIn">
      <div className="bg-[#8B6465] text-white p-4 rounded-full mb-4">{icon}</div>
